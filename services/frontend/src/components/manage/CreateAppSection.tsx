  ...
  return (
    ...
    >
      ...
      >
        ...
        <Field label="Domains" className="col-[1/-2] max-[860px]:col-auto">
          <Input
      ...
      {state.notice ? (
        <p className="m-0 border-t border-[#c9c1afbf] px-4 py-[18px] font-mono text-[.82rem] leading-[1.4] font-extrabold text-[#517a38]">
          {state.notice}
        </p>
      ) : null}
    </section>
